<template>
  <Form ref="formRef" :model="formState" layout="vertical">
    <Form.Item name="fetchAlarmRulesStateOnStart">
      <Checkbox v-model:value="formState.fetchAlarmRulesStateOnStart"> 保持报警规则状态 </Checkbox>
    </Form.Item>
    <Form.Item name="persistAlarmRulesState">
      <Checkbox v-model:value="formState.persistAlarmRulesState"> 获取报警规则状态 </Checkbox>
    </Form.Item>
  </Form>
</template>
<script lang="ts">
