<template>
  <Form ref="formRef" :model="formState" layout="vertical">
    <Form.Item name="useSystemSmtpSettings">
      <Checkbox v-model:checked="formState.useSystemSmtpSettings"> 使用系统SMTP设置 </Checkbox>
    </Form.Item>
      ...
      <Row :gutter="20">
        ...
        <Col :span="24">
          <Form.Item name="enableTls">
            <Checkbox v-model:checked="formState.enableTls"> 启用TLS </Checkbox>
          </Form.Item>
        </Col>
        ...
        <Col :span="24">
          <Form.Item name="enableProxy">
            <Checkbox v-model:checked="formState.enableProxy"> 启用代理 </Checkbox>
          </Form.Item>
        </Col>
