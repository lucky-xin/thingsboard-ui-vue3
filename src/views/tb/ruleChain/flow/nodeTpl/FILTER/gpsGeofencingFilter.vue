        ...
        <Row :gutter="20">
          <Col :span="12">
            <Form.Item
              ...
              :rules="[{ required: true, message: '纬度字段名称不能为空!' }]"
            >
          ...
          <Col :span="12">
            <Form.Item
              ...
              :rules="[{ required: true, message: '经度字段名称不能为空!' }]"
            >
    ...
    <div class="border border-neutral-400 p-2 rounded mt-3">
      ...
      <div class="p-2">
        ...
        <Form.Item
          ...
          :rules="[{ required: true, message: '边界信息字段不能为空!' }]"
          help="包含边界信息的元数据字段名称。"
        ...
        <Form.Item
          ...
          :rules="[{ required: true, message: '范围边界不能为空!' }]"
        ...
        >
          <Col :span="12">
            <Form.Item
              label="圆心纬度"
              name="centerLatitude"
              :rules="[{ required: true, message: '圆心纬度不能为空!' }]"
            >
          ...
          <Col :span="12">
            <Form.Item
              ...
              :rules="[{ required: true, message: '圆心经度不能为空!' }]"
            >
              <InputNumber v-model:value="formState.centerLatitude" :style="{ width: '100%' }" :step="0.01" />
            </Form.Item>
          </Col>
