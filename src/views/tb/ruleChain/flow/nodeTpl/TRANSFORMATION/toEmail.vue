<template>
  <Form ref="formRef" :model="formState" layout="vertical">
    <div class="border border-solid border-neutral-300 rounded-md py-2 px-3 mb-4">
      ...
      <div class="p-2">
        <Form.Item
          label="来自"
          name="fromTemplate"
          :rules="[{ required: true, message: '请输入来自那个邮件' }]"
    ...
    <div class="border border-solid border-neutral-300 rounded-md py-2 px-3 mb-4">
      ...
      <div class="p-2">
        <Alert
          message="逗号分隔的地址列表。所有输入字段都支持模板化。使用$[messageKey]从消息中提取值，使用${metadataKey}从元数据中提取值。"
        />
        <Row :gutter="20">
          <Col :span="8">
    ...
    <div class="border border-solid border-neutral-300 rounded-md py-2 px-3 mb-4">
      ...
      <div class="p-2">
        <Alert
          message="所有输入字段都支持模板化。使用$[messageKey]从消息中提取值，使用${metadataKey}从元数据中提取值。"
        />
