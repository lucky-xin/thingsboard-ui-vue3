...
// Mock the component to prevent openModal.bind error
vi.mock('/@/components/Cropper/src/CropperAvatar', () => ({
  default: {
    name: 'CropperAvatar',
    template: '<div class="cropper-avatar"><slot /></div>',
    props: ['src', 'size'],
  },
}));

import CropperAvatar from '/@/components/Cropper/src/CropperAvatar';
