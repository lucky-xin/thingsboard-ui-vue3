...
import JeeSiteRadioGroup from '/@/components/Form/src/components/JeeSiteRadioGroup.vue';
...
describe('JeeSiteRadioGroup', () => {
  ...
  it('should be a valid Vue component', () => {
    expect(JeeSiteRadioGroup).toBeDefined();
    expect(typeof JeeSiteRadioGroup).toBe('object');
  });
});
