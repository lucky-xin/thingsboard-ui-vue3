...
describe('components/Form/src/helper Coverage Tests', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe('processDateValue', () => {
    ...
    it('should handle array value for RangePicker without valueFormat', () => {
      const mockDateInstance = {
        format: vi.fn(() => '2023-09-27'),
      };
      vi.mocked(dateUtil).mockReturnValue(mockDateInstance);
      ...
      const value = [new Date('2023-09-27'), new Date('2023-09-28')];
      const component = 'RangePicker';
      const componentProps = {}; // No valueFormat
    ...
    it('should handle single date value without valueFormat', () => {
      const mockDateInstance = {
        format: vi.fn(() => '2023-09-27'),
      };
      vi.mocked(dateUtil).mockReturnValue(mockDateInstance);
    ...
    it('should handle array with null values', () => {
      const value = [new Date('2023-09-27'), null];
      const component = 'RangePicker';
      const componentProps = { valueFormat: 'YYYY-MM-DD' };

      const result = processDateValue(value, component, componentProps);

      expect(result).toEqual(['2023-09-27', null]);
    });

    it('should handle array with undefined values', () => {
      const value = [new Date('2023-09-27'), undefined];
      const component = 'RangePicker';
      const componentProps = { valueFormat: 'YYYY-MM-DD' };
  ...
  describe('processNumberValue', () => {
    it('should process number value for Input components', () => {
      ...
      expect(isNumber).toHaveBeenCalledWith(value);
      expect(result).toBe('123');
    });

    it('should process number value for InputPassword components', () => {
      vi.mocked(isNumber).mockReturnValue(true);
    ...
    it('should process number value for InputSearch components', () => {
      vi.mocked(isNumber).mockReturnValue(true);
    ...
    it('should process number value for InputTextArea components', () => {
      vi.mocked(isNumber).mockReturnValue(true);
