...
describe('components/Transition/src/ExpandTransition', () => {
  ...
  describe('default export', () => {
    ...
    it('should handle different expanded parent classes', () => {
      const className = 'custom-expanded-class';
      const transition = expandTransition(className);

      transition.beforeEnter(mockElement);
      transition.enter(mockElement);

      expect(mockParent.classList.add).toHaveBeenCalledWith(className);
    });

    it('should handle leave with different size properties', () => {
      const transition = expandTransition('', true);
    ...
    it('should handle afterLeave with different expanded parent classes', () => {
      const className = 'custom-expanded-class';
      const transition = expandTransition(className);
      ...
      expect(mockParent.classList.remove).toHaveBeenCalledWith(className);
    });

    it('should handle leaveCancelled with different expanded parent classes', () => {
      const className = 'custom-expanded-class';
      const transition = expandTransition(className);
  ...
  describe('upperFirst function', () => {
    it('should capitalize first character', () => {
      expect(upperFirst('height')).toBe('Height');
      expect(upperFirst('width')).toBe('Width');
