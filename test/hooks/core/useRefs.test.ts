...
describe('hooks/core/useRefs', () => {
  function setupUseRefs() {
    ...
    const wrapper = defineComponent({
      setup() {
        const result = useRefs<HTMLElement>();
        refs = result.refs;
        setRefs = result.setRefs;
        return result;
      },
      render() {
        return null;
    ...
    return { refs, setRefs, component };
  }

  it('should create refs array and setRefs function', () => {
    const { refs, setRefs } = setupUseRefs();
