...
describe('locales/helper', () => {
  ...
  describe('genMessage', () => {
    ...
    it('should handle language modules with undefined default (fallback to empty object)', () => {
      const mockLangs = {
        './lang/en.ts': {
          default: undefined,
        },
    ...
    it('should handle language modules with null default (fallback to empty object)', () => {
      const mockLangs = {
        './lang/en.ts': {
          default: null,
        },
