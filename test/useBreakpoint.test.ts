...
describe('useBreakpoint', () => {
  ...
  it('should handle XS screen size', () => {
    Object.defineProperty(global.document, 'body', { value: { clientWidth: 400 }, writable: true });
  ...
  it('should handle SM screen size', () => {
    Object.defineProperty(global.document, 'body', { value: { clientWidth: 576 }, writable: true });
  ...
  it('should handle MD screen size', () => {
    Object.defineProperty(global.document, 'body', { value: { clientWidth: 768 }, writable: true });
  ...
  it('should handle LG screen size', () => {
    Object.defineProperty(global.document, 'body', { value: { clientWidth: 992 }, writable: true });
  ...
  it('should handle XXL screen size', () => {
    Object.defineProperty(global.document, 'body', { value: { clientWidth: 1600 }, writable: true });
  ...
  it('should call callback function with correct parameters', () => {
    ...
    expect(callback).toHaveBeenCalledWith({
      screen: result.screenRef,
      width: result.widthRef,
      realWidth: result.realWidthRef,
      screenEnum,
      screenMap,
      sizeEnum,
    });
  ...
  it('should return useBreakpoint values', () => {
